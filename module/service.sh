...
setprop persist.vendor.camera.selfie.noise.reduction 1
setprop ro.vendor.camera.selfie.ai.face.detect on
setprop ro.vendor.camera.selfie.ai.beauty.enable 1
setprop ro.vendor.camera.selfie.ai.lowlight.threshold 13
...
setprop ro.vendor.camera.selfie.ai.scene.detect 1
setprop persist.vendor.camera.eis.enable 1
setprop persist.vendor.camera.ois.disable 0
...
setprop ro.surface_flinger.force_hwc_copy_for_virtual_displays=true
setprop ro.surface_flinger.max_frame_buffer_acquired_buffers 7
...
setprop windowsmgr.max_events_per_sec 680
...
setprop persist.sys.scrollingcache 11
